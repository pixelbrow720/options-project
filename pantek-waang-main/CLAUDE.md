...
docker compose up --build     # db (timescale), backend :8000, frontend :3000
```
...
```bash
npm install
npm run dev                 # :3000, proxies VITE_API_BASE_URL
